...
public interface SpotifyService {
    ...
    /**
     * Get the currently listened track.
     *
     * @return The current listened track
     * @see <a href="https://developer.spotify.com/web-api/get-the-users-currently-playing-track/">Get Current User's playing track</a>
     */
    @GET("/me/player")
    CurrentlyPlaying getCurrentlyPlayingTrack();

    /**
     * Pause playback on the user’s account.
     *
     * @param callback
     * @see <a href="https://developer.spotify.com/web-api/pause-a-users-playback/">Pause a User’s Playback</a>
     */
    @PUT("/me/player/pause")
    void pause(Callback<Result> callback);

    /**
     * Start/Resume a User's Playback
     *
     * @param callback
     * @see <a href="https://developer.spotify.com/web-api/console/put-play/">Start/Resume a User's Playback</a>
     */
    @PUT("/me/player/play")
    void play(Callback<Result> callback);
